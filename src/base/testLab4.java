...
public class testLab4 {
	public static void main(String args[]) throws Exception{
		...
		if(new File(((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTiltle().replaceAll(" ", "_")+".txt").exists()){
			System.out.println("TextNote exported in " + new File(((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTiltle().replaceAll(" ", "_")+".txt").getAbsolutePath());
		}else{
			throw new Exception("Your code has some problems.......");
		}
